...
public class HelloServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "getGreeting": {
          service.getGreeting(json.getValue("amount") == null ? null : (json.getLong("amount").intValue()), (io.vertx.core.json.JsonObject)json.getValue("quote"), createHandler(msg));
          break;
        }
        case "setAmount": {
          service.setAmount(createHandler(msg));
          break;
        }
        default: {
